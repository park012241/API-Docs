# javaTeamP OpenAPI Specification
[![Build Status](https://travis-ci.com/https://github.com/DSMJavaTeamProject/API-Docs.svg?branch=master)](https://travis-ci.com/https://github.com/DSMJavaTeamProject/API-Docs)
## Steps to finish
...
- [Reference Documentation (ReDoc)](https://https:.github.io//)
- OpenAPI Raw Files: [JSON](https://https:.github.io//openapi.json) [YAML](https://https:.github.io//openapi.yaml)
